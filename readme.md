# [rust-embassy] 📟
![](https://img.shields.io/gitlab/pipeline-status/agent-framework/rust-embassy?branch=main&logo=gitlab)
![](https://gitlab.com/agent-framework/rust-embassy/badges/main/coverage.svg)
